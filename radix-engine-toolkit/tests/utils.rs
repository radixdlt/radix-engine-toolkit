...
fn extraction_of_metadata_from_receipts_succeeds() {
    ...
    let metadata = radix_engine_toolkit::utils::metadata_of_newly_created_entities(&receipt);
...
fn extraction_of_non_fungible_data_from_receipts_succeeds() {
    ...
    let new_non_fungibles =
        radix_engine_toolkit::utils::data_of_newly_minted_non_fungibles(&receipt);
