...
impl<'a> Function<'a> for InstructionsHash {
    ...
    fn handle(
        ...
        let hash = radix_engine_toolkit_core::functions::instructions::hash(&instructions)
            .map_err(|error| {
...
impl<'a> Function<'a> for InstructionsCompile {
    ...
    fn handle(
        ...
        let compiled = radix_engine_toolkit_core::functions::instructions::compile(&instructions)
            .map_err(|error| {
            InvocationHandlingError::EncodeError(debug_string(error), debug_string(instructions))
        })?;
...
impl<'a> Function<'a> for InstructionsDecompile {
    ...
    fn handle(
        ...
        let instructions = radix_engine_toolkit_core::functions::instructions::decompile(
            &**compiled,
        )
        .map_err(|error| {
...
impl<'a> Function<'a> for InstructionsStaticallyValidate {
    ...
    fn handle(
        ...
        match radix_engine_toolkit_core::functions::instructions::statically_validate(&instructions)
        {
...
impl<'a> Function<'a> for InstructionsExtractAddresses {
    ...
    fn handle(
        ...
        let (addresses, named_addresses) =
            radix_engine_toolkit_core::functions::instructions::extract_addresses(&instructions);
