...
use transaction::prelude::{
    AesGcmPayload, AesWrapped128BitKey, CurveType, DecryptorsByCurve, EncryptedMessageV1,
    MessageContentsV1, MessageV1, PlaintextMessageV1, PublicKeyFingerprint,
};
...
impl From<SerializableMessage> for MessageV1 {
    fn from(value: SerializableMessage) -> Self {
        match value {
            ...
            SerializableMessage::Encrypted(value) => Self::Encrypted(value.into()),
            SerializableMessage::PlainText(value) => Self::Plaintext(value.into()),
        }
    }
}
...
impl From<SerializableMessageContent> for MessageContentsV1 {
    fn from(value: SerializableMessageContent) -> Self {
        match value {
            ...
            SerializableMessageContent::String(value) => MessageContentsV1::String(value),
        }
    }
}
