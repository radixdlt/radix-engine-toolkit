...
fn signed_intent_can_be_compiled() {
    ...
    // Act
    let compiled = radix_engine_toolkit_core::functions::signed_intent::compile(&signed_intent);
...
fn signed_intent_can_be_compiled_and_later_decompiled() {
    ...
    let signed_intent = test_data::signed_intent();
    let compiled =
        radix_engine_toolkit_core::functions::signed_intent::compile(&signed_intent).unwrap();

    // Act
    let decompiled = radix_engine_toolkit_core::functions::signed_intent::decompile(compiled);
