...
fn notarized_transaction_hash_can_be_obtained() {
    ...
    // Act
    let hash = radix_engine_toolkit_core::functions::notarized_transaction::hash(&transaction);
...
fn notarized_transaction_can_be_compiled() {
    ...
    // Act
    let compiled =
        radix_engine_toolkit_core::functions::notarized_transaction::compile(&transaction);
...
fn notarized_transaction_can_be_compiled_and_later_decompiled() {
    ...
    let transaction = test_data::notarized_transaction();
    let compiled =
        radix_engine_toolkit_core::functions::notarized_transaction::compile(&transaction).unwrap();
...
fn notarized_transaction_can_be_statically_validated() {
    ...
    let validation_result =
        radix_engine_toolkit_core::functions::notarized_transaction::statically_validate(
            &transaction,
            validation_config,
        );
