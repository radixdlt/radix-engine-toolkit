...
impl<'a> Function<'a> for InstructionsHash {
    ...
    fn handle(
        ...
        let hash = radix_engine_toolkit_core::functions::instructions::hash(
            &instructions,
        )
        .map_err(|error| {
...
impl<'a> Function<'a> for InstructionsCompile {
    ...
    fn handle(
        ...
        let compiled =
            radix_engine_toolkit_core::functions::instructions::compile(
                &instructions,
            )
            .map_err(|error| {
                InvocationHandlingError::EncodeError(
...
impl<'a> Function<'a> for InstructionsDecompile {
    ...
    fn handle(
        ...
        let instructions =
            radix_engine_toolkit_core::functions::instructions::decompile(
                &**compiled,
            )
            .map_err(|error| {
                InvocationHandlingError::EncodeError(
