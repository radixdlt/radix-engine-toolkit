    ...
    fn from(value: PublicKey) -> Self {
        match value {
            PublicKey::Secp256k1(public_key) => {
                Self::Secp256k1(public_key.0.into())
            }
            PublicKey::Ed25519(public_key) => {
                Self::Ed25519(public_key.0.into())
            }
        }
    }
}
...
impl From<SerializablePublicKey> for PublicKey {
    fn from(value: SerializablePublicKey) -> Self {
        match value {
            ...
            SerializablePublicKey::Ed25519(value) => {
                Self::Ed25519(Ed25519PublicKey(*value))
            }
        }
    }
}
...
pub struct SerializableSecp256k1PublicKey(
    #[typeshare(serialized_as = "String")] AsHex<[u8; 33]>,
);
...
pub struct SerializableEd25519PublicKey(
    #[typeshare(serialized_as = "String")] AsHex<[u8; 32]>,
);
