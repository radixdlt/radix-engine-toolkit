...
impl<'f> HasExamples<'f, NUMBER_OF_MANIFESTS_DOUBLE>
    for NotarizedTransactionCompile
{
    fn example_inputs() -> [Self::Input; NUMBER_OF_MANIFESTS_DOUBLE] {
        notarized_transactions()
    }
...
impl<'f> HasExamples<'f, NUMBER_OF_MANIFESTS_DOUBLE>
    for NotarizedTransactionDecompile
{
    fn example_inputs() -> [Self::Input; NUMBER_OF_MANIFESTS_DOUBLE] {
...
impl<'f> HasExamples<'f, NUMBER_OF_MANIFESTS_DOUBLE>
    for NotarizedTransactionStaticallyValidate
{
    fn example_inputs() -> [Self::Input; NUMBER_OF_MANIFESTS_DOUBLE] {
...
pub fn notarized_transactions(
) -> [SerializableNotarizedTransaction; NUMBER_OF_MANIFESTS_DOUBLE] {
