...
fn manifest_can_be_compiled_and_later_decompiled() {
    ...
    // Act
    let decompiled =
        radix_engine_toolkit_core::functions::manifest::decompile(compiled);
...
fn manifest_can_be_statically_validated() {
    ...
    let validation_result =
        radix_engine_toolkit_core::functions::manifest::statically_validate(
            &manifest,
        );
...
fn manifest_modification_assertions_are_added_at_expected_indices() {
    ...
    let modified_manifest =
        radix_engine_toolkit_core::functions::manifest::modify(
            &manifest,
            modifications,
        )
        .unwrap();
...
fn assertion_out_of_bounds_results_in_an_error_not_a_panic() {
    ...
    // Act
    let result = radix_engine_toolkit_core::functions::manifest::modify(
        &manifest,
        modifications,
    );
