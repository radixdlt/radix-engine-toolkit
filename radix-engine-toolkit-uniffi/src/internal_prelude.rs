...
mod native {
    ...
    pub use radix_engine_interface::blueprints::account::{
        ...
        AccountChangeDefaultDepositRuleInput as NativeAccountChangeDefaultDepositRuleInput,
        AccountConfigureResourceDepositRuleInput as NativeAccountConfigureResourceDepositRuleInput,
        ...
        ACCOUNT_CREATE_VIRTUAL_SECP256K1_ID as NATIVE_ACCOUNT_CREATE_VIRTUAL_SECP256K1_ID,
        ACCOUNT_CREATE_VIRTUAL_ED25519_ID as NATIVE_ACCOUNT_CREATE_VIRTUAL_ED25519_ID,
        ...
        ACCOUNT_CHANGE_DEFAULT_DEPOSIT_RULE_IDENT as NATIVE_ACCOUNT_CHANGE_DEFAULT_DEPOSIT_RULE_IDENT,
        ACCOUNT_CONFIGURE_RESOURCE_DEPOSIT_RULE_IDENT as NATIVE_ACCOUNT_CONFIGURE_RESOURCE_DEPOSIT_RULE_IDENT,
