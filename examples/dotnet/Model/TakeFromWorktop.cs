...
namespace Model
{
    ...
    public partial class TakeFromWorktop : Instruction,  IEquatable<TakeFromWorktop>, IValidatableObject
    {
        ...
        protected TakeFromWorktop() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TakeFromWorktop" /> class.
        /// </summary>
        /// <param name="resourceAddress">resourceAddress (required).</param>
        /// <param name="intoBucket">intoBucket (required).</param>
        public TakeFromWorktop(ResourceAddress resourceAddress = default(ResourceAddress), Bucket intoBucket = default(Bucket), string instruction = "TAKE_FROM_WORKTOP") : base(instruction)
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new InvalidDataException("resourceAddress is a required property for TakeFromWorktop and cannot be null");
            }
            else
            {
            ...
            if (intoBucket == null)
            {
                throw new InvalidDataException("intoBucket is a required property for TakeFromWorktop and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TakeFromWorktop {\n");
        ...
        {
            return this.Equals(input as TakeFromWorktop);
        }

        /// <summary>
        /// Returns true if TakeFromWorktop instances are equal
        /// </summary>
        /// <param name="input">Instance of TakeFromWorktop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TakeFromWorktop input)
        {
            if (input == null)
                return false;
