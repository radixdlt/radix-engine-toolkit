...
namespace Model
{
    ...
    public partial class CreateProofFromAuthZone : Instruction,  IEquatable<CreateProofFromAuthZone>, IValidatableObject
    {
        ...
        protected CreateProofFromAuthZone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProofFromAuthZone" /> class.
        /// </summary>
        /// <param name="resourceAddress">resourceAddress (required).</param>
        /// <param name="intoProof">intoProof (required).</param>
        public CreateProofFromAuthZone(ResourceAddress resourceAddress = default(ResourceAddress), Proof intoProof = default(Proof), string instruction = "CREATE_PROOF_FROM_AUTH_ZONE") : base(instruction)
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new InvalidDataException("resourceAddress is a required property for CreateProofFromAuthZone and cannot be null");
            }
            else
            {
            ...
            if (intoProof == null)
            {
                throw new InvalidDataException("intoProof is a required property for CreateProofFromAuthZone and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProofFromAuthZone {\n");
        ...
        {
            return this.Equals(input as CreateProofFromAuthZone);
        }

        /// <summary>
        /// Returns true if CreateProofFromAuthZone instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProofFromAuthZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProofFromAuthZone input)
        {
            if (input == null)
                return false;
