...
namespace Model
{
    ...
    public partial class CallMethod : Instruction,  IEquatable<CallMethod>, IValidatableObject
    {
        ...
        public CallMethod(ComponentAddress componentAddress = default(ComponentAddress), String methodName = default(String), List<Value> arguments = default(List<Value>), string instruction = "CALL_METHOD") : base(instruction)
        {
