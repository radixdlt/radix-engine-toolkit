...
namespace Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Set : Value,  IEquatable<Set>, IValidatableObject
    {
        /// <summary>
        ...
        public Set(ValueKind elementType = default(ValueKind), List<Value> elements = default(List<Value>), string type = "Set") : base(type)
        {
            // to ensure "elementType" is required (not null)
            if (elementType == null)
            {
                throw new InvalidDataException("elementType is a required property for Set and cannot be null");
            }
            else
            {
            ...
            if (elements == null)
            {
                throw new InvalidDataException("elements is a required property for Set and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Set);
        }

        /// <summary>
        /// Returns true if Set instances are equal
        /// </summary>
        /// <param name="input">Instance of Set to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Set input)
        {
            if (input == null)
                return false;
