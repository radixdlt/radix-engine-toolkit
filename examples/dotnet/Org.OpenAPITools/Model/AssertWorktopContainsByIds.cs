...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AssertWorktopContainsByIds : Instruction,  IEquatable<AssertWorktopContainsByIds>, IValidatableObject
    {
        ...
        public AssertWorktopContainsByIds(ResourceAddress resourceAddress = default(ResourceAddress), List<NonFungibleId> ids = default(List<NonFungibleId>), string instruction = "ASSERT_WORKTOP_CONTAINS_BY_IDS") : base(instruction)
        {
