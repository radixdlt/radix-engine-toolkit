...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class UnexpectedContents : ErrorResponse,  IEquatable<UnexpectedContents>, IValidatableObject
    {
        ...
        public UnexpectedContents(ValueKind kind = default(ValueKind), List<ValueKind> expected = default(List<ValueKind>), ValueKind found = default(ValueKind), string error = "UnexpectedContents") : base(error)
        {
