...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateProofFromAuthZoneAllOf :  IEquatable<CreateProofFromAuthZoneAllOf>, IValidatableObject
    {
        ...
        protected CreateProofFromAuthZoneAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProofFromAuthZoneAllOf" /> class.
        /// </summary>
        /// <param name="resourceAddress">resourceAddress (required).</param>
        /// <param name="intoProof">intoProof (required).</param>
        public CreateProofFromAuthZoneAllOf(ResourceAddress resourceAddress = default(ResourceAddress), Proof intoProof = default(Proof))
        {
            // to ensure "resourceAddress" is required (not null)
            if (resourceAddress == null)
            {
                throw new InvalidDataException("resourceAddress is a required property for CreateProofFromAuthZoneAllOf and cannot be null");
            }
            else
            {
            ...
            if (intoProof == null)
            {
                throw new InvalidDataException("intoProof is a required property for CreateProofFromAuthZoneAllOf and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProofFromAuthZoneAllOf {\n");
        ...
        {
            return this.Equals(input as CreateProofFromAuthZoneAllOf);
        }

        /// <summary>
        /// Returns true if CreateProofFromAuthZoneAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProofFromAuthZoneAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProofFromAuthZoneAllOf input)
        {
            if (input == null)
                return false;
