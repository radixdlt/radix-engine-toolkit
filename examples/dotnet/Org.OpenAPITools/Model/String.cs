...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class String : Value,  IEquatable<String>, IValidatableObject
    {
        /// <summary>
        ...
        public String(string value = default(string), string type = "String") : base(type)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for String and cannot be null");
            }
            else
            {
                this.Value = value;
