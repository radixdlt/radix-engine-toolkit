...
namespace Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Vault : Value,  IEquatable<Vault>, IValidatableObject
    {
        /// <summary>
        ...
        public Vault (string identifier = default(string)) : base ("Vault")
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for Vault and cannot be null");
            }
            else
            {
