...
{
    /// <summary>
    /// The response to the &#x60;DecompileUnknownTransactionIntentRequest&#x60; containing the decompiled transaction intent
    /// </summary>
    [DataContract]
    public partial class DecompileUnknownTransactionIntentResponse :  IEquatable<DecompileUnknownTransactionIntentResponse>, IValidatableObject
    {
        ...
        public DecompileUnknownTransactionIntentResponse(TransactionHeader header = default(TransactionHeader), TransactionManifest manifest = default(TransactionManifest), TransactionIntent transactionIntent = default(TransactionIntent), List<Signature> signatures = default(List<Signature>), SignedTransactionIntent signedIntent = default(SignedTransactionIntent), EcdsaSignatureString notarySignature = default(EcdsaSignatureString))
        {
        ...
        public EcdsaSignatureString NotarySignature { get; set; }
