...
{
    /// <summary>
    /// The response to the &#x60;DecodeAddressRequest&#x60; containing the deocded address
    /// </summary>
    [DataContract]
    public partial class DecodeAddressResponse :  IEquatable<DecodeAddressResponse>, IValidatableObject
    {
        ...
        /// <param name="data">The hex-encoded data which was in the bech32m-encoded address (required).</param>
        /// <param name="hrp">The HRP (human readable part) of the bech32m-encoded address (required).</param>
        ...
        /// <summary>
        /// The hex-encoded data which was in the bech32m-encoded address
        /// </summary>
        /// <value>The hex-encoded data which was in the bech32m-encoded address</value>
        [DataMember(Name="data", EmitDefaultValue=true)]
        public string Data { get; set; }

        /// <summary>
        /// The HRP (human readable part) of the bech32m-encoded address
        /// </summary>
        /// <value>The HRP (human readable part) of the bech32m-encoded address</value>
