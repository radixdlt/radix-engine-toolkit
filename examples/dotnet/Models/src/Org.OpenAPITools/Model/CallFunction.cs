...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CallFunction : Instruction,  IEquatable<CallFunction>, IValidatableObject
    {
        ...
        public CallFunction(PackageAddress packageAddress = default(PackageAddress), String blueprintName = default(String), String functionName = default(String), List<Value> arguments = default(List<Value>)) : base(instruction)
        {
