...
{
    /// <summary>
    /// A request to take the SBOR-encoded compiled transaction intent and decompile it into a format supported by the library (either &#x60;JSON&#x60; or &#x60;String&#x60;)
    /// </summary>
    [DataContract]
    public partial class DecompileTransactionIntentRequest :  IEquatable<DecompileTransactionIntentRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DecompileTransactionIntentRequest" /> class.
        /// </summary>
        /// <param name="compiledIntent">The hex-encoded string of the compiled transaction intent (required).</param>
        ...
        /// <summary>
        /// The hex-encoded string of the compiled transaction intent
        /// </summary>
        /// <value>The hex-encoded string of the compiled transaction intent</value>
