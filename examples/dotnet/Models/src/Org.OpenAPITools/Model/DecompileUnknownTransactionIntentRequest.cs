...
{
    /// <summary>
    /// A request to decompile a compiled transaction intent of an unknown format to 
    /// </summary>
    [DataContract]
    public partial class DecompileUnknownTransactionIntentRequest :  IEquatable<DecompileUnknownTransactionIntentRequest>, IValidatableObject
    {
        ...
        /// <param name="compiledUnknownIntent">The unknown transaction intent provided as a hex-encoded string (required).</param>
        ...
        /// <summary>
        /// The unknown transaction intent provided as a hex-encoded string
        /// </summary>
        /// <value>The unknown transaction intent provided as a hex-encoded string</value>
