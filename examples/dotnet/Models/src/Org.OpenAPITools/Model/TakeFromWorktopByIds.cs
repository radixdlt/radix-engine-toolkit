...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TakeFromWorktopByIds : Instruction,  IEquatable<TakeFromWorktopByIds>, IValidatableObject
    {
        ...
        public TakeFromWorktopByIds(ResourceAddress resourceAddress = default(ResourceAddress), List<NonFungibleId> ids = default(List<NonFungibleId>), Bucket intoBucket = default(Bucket)) : base(instruction)
        {
