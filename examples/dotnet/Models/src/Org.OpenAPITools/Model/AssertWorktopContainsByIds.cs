...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AssertWorktopContainsByIds : Instruction,  IEquatable<AssertWorktopContainsByIds>, IValidatableObject
    {
        ...
        public AssertWorktopContainsByIds(ResourceAddress resourceAddress = default(ResourceAddress), List<NonFungibleId> ids = default(List<NonFungibleId>)) : base(instruction)
        {
