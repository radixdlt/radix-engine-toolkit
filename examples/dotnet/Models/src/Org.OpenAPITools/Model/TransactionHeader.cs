...
{
    /// <summary>
    /// A transaction header used to describe different parameters about the transactions
    /// </summary>
    [DataContract]
    public partial class TransactionHeader :  IEquatable<TransactionHeader>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TransactionHeader" /> class.
        /// </summary>
        /// <param name="version">An 8-bit unsigned number. (required).</param>
        /// <param name="networkId">An 8-bit unsigned number. (required).</param>
        /// <param name="startEpochInclusive">A 64-bit unsigned integer representing the epoch the earliest that this transaction can be executed (required).</param>
        /// <param name="endEpochExclusive">A 64-bit unsigned integer representing the latest epoch this transaction should be executed (required).</param>
        /// <param name="nonce">A 64-bit unsigned integer of the nonce to use for the transaction (required).</param>
        /// <param name="notaryPublicKey">notaryPublicKey (required).</param>
        /// <param name="notaryAsSignatory">A boolean representing whether the notary is also one of the people signing the transaction (required).</param>
        /// <param name="costUnitLimit">A 32-bit unsigned integer of the maximum cost units that this transaction can spend (required).</param>
        /// <param name="tipPercentage">A 32-bit unsigned integer of the percentage of the tip to give to validators (required).</param>
        public TransactionHeader(int version = default(int), int networkId = default(int), int startEpochInclusive = default(int), int endEpochExclusive = default(int), int nonce = default(int), EcdsaPublicKeyString notaryPublicKey = default(EcdsaPublicKeyString), bool notaryAsSignatory = default(bool), int costUnitLimit = default(int), int tipPercentage = default(int))
        {
        ...
        /// <summary>
        /// A 64-bit unsigned integer representing the epoch the earliest that this transaction can be executed
        /// </summary>
        /// <value>A 64-bit unsigned integer representing the epoch the earliest that this transaction can be executed</value>
        [DataMember(Name="start_epoch_inclusive", EmitDefaultValue=true)]
        public int StartEpochInclusive { get; set; }

        /// <summary>
        /// A 64-bit unsigned integer representing the latest epoch this transaction should be executed
        /// </summary>
        /// <value>A 64-bit unsigned integer representing the latest epoch this transaction should be executed</value>
        [DataMember(Name="end_epoch_exclusive", EmitDefaultValue=true)]
        public int EndEpochExclusive { get; set; }

        /// <summary>
        /// A 64-bit unsigned integer of the nonce to use for the transaction
        /// </summary>
        /// <value>A 64-bit unsigned integer of the nonce to use for the transaction</value>
        ...
        public EcdsaPublicKeyString NotaryPublicKey { get; set; }

        /// <summary>
        /// A boolean representing whether the notary is also one of the people signing the transaction
        /// </summary>
        /// <value>A boolean representing whether the notary is also one of the people signing the transaction</value>
        [DataMember(Name="notary_as_signatory", EmitDefaultValue=true)]
        public bool NotaryAsSignatory { get; set; }

        /// <summary>
        /// A 32-bit unsigned integer of the maximum cost units that this transaction can spend
        /// </summary>
        /// <value>A 32-bit unsigned integer of the maximum cost units that this transaction can spend</value>
        [DataMember(Name="cost_unit_limit", EmitDefaultValue=true)]
        public int CostUnitLimit { get; set; }

        /// <summary>
        /// A 32-bit unsigned integer of the percentage of the tip to give to validators
        /// </summary>
        /// <value>A 32-bit unsigned integer of the percentage of the tip to give to validators</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.TipPercentage > (int)4294967295)
            {
