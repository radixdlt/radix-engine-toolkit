...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TakeFromWorktopByAmount : Instruction,  IEquatable<TakeFromWorktopByAmount>, IValidatableObject
    {
        ...
        public TakeFromWorktopByAmount(ResourceAddress resourceAddress = default(ResourceAddress), Decimal amount = default(Decimal), Bucket intoBucket = default(Bucket)) : base(instruction)
        {
