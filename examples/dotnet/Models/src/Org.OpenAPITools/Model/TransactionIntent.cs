...
{
    /// <summary>
    /// A transaction intent of what the transaction it meant to do as well as the header parameters
    /// </summary>
    [DataContract]
    public partial class TransactionIntent :  IEquatable<TransactionIntent>, IValidatableObject
    {
        ...
        public TransactionIntent(TransactionHeader header = default(TransactionHeader), TransactionManifest manifest = default(TransactionManifest))
        {
            // to ensure "header" is required (not null)
            if (header == null)
            {
                throw new InvalidDataException("header is a required property for TransactionIntent and cannot be null");
            }
            else
            {
                this.Header = header;
            ...
            if (manifest == null)
            {
                throw new InvalidDataException("manifest is a required property for TransactionIntent and cannot be null");
            }
            else
            {
