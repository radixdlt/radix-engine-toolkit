...
export default class ManifestBuilder {
	...
	callMethod(component_address: string, method_name: string, args?: Value.Value[]): this {
		this.instructions.push({
	...
	returnToWorktop(bucket_identifier: string | number): this {
		// TODO: If the bucket identifier is a number, check that number is an unsigned integer in
		// the bounds of a u32.
		this.instructions.push({
	...
	assertWorktopContains(resource_address: string): this {
		// TODO: If the bucket identifier is a number, check that number is an unsigned integer in
		// the bounds of a u32.
		this.instructions.push({
	...
	assertWorktopContainsByAmount(amount: number, resource_address: string): this {
		// TODO: If the bucket identifier is a number, check that number is an unsigned integer in
		// the bounds of a u32.
		this.instructions.push({
	...
	assertWorktopContainsByIds(ids: Value.NonFungibleId[], resource_address: string): this {
		this.instructions.push({
	...
	popFromAuthZone(proof_identifier: string | number): this {
		this.instructions.push({
	...
	pushToAuthZone(proof_identifier: string | number): this {
		this.instructions.push({
	...
	createProofFromAuthZone(resource_address: string, proof_identifier: string | number): this {
	...
	dropProof(proof_identifier: string | number): this {
		this.instructions.push({
